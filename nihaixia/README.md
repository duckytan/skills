...
| 模块 | 文件 | 内容 |
|------|------|------|
| **八字判定** | `docs/02-体质先天判定.md` | 八字判定方法论 + 通用算法 + 5 字段输出模板 |
| **排盘脚本** | `scripts/bazi_paipan.py` | 通用八字排盘（任意公历生日可用）|
| **调用钩子** | `docs/01-问诊十问.md` v1.1 | 十问清单 + 八字调用钩子 |
...
**完整安装排错**：详见 [`INSTALL.md`](./INSTALL.md) 或 [`02-体质先天判定.md` § 常见安装问题](./docs/02-体质先天判定.md)。
