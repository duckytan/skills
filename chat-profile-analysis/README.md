...
[![Version](https://img.shields.io/badge/version-1.1-blue.svg)](https://github.com/yourusername/chat-profile-analysis)
...
在分析报告生成后，自动创建 **3-5 个专业的 AI 绘图提示词**，用于：

- 🖼️ **Midjourney / DALL-E / Stable Diffusion** 等工具生成信息图
- 📐 **9:16 竖版格式**，完美适配手机屏幕和小红书
- 📊 **高密度信息图**：多文字 + 适当配图，4K 高清
- 🎯 **多角度呈现**：人格雷达图、词云、时间轴、价值观海报等
- ✨ **一键复制**：直接粘贴到 AI 绘图工具即可使用
...
**使用方法：**
- 复制提示词到 Midjourney: `/imagine [提示词]`
- 或使用 DALL-E 3 / Stable Diffusion 生成
- 30-60 秒后获得 4K 高清信息图
